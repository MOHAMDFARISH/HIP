...
// Supabase connection
const supabaseUrl = process.env.SUPABASE_URL || 'https://hawlariza.com/supabase.co';
...
const DEFAULT_METADATA = {
  pageUrl: 'https://hawlariza.com/faq',
  pageTitle: 'FAQ | Heal in Paradise - Frequently Asked Questions',
  pageDescription: 'Find answers to frequently asked questions about Heal in Paradise, ordering, shipping, and more. Get all the information you need about this Maldivian literary souvenir.',
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  res.setHeader('X-Page-Handler', 'faq');
  ...
  try {
    ...
    // Generate FAQPage structured data (JSON-LD) for rich results
    const faqSchema = {
      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Heal in Paradise is the first-ever Maldivian literary souvenir - a collection of poetry by Hawla Riza about hope, healing, and island life in the Maldives.',
          },
        },
        {
          '@type': 'Question',
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'You can order Heal in Paradise through our website at hawlariza.com/book. We offer worldwide shipping.',
          },
        },
        {
          '@type': 'Question',
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Hawla Riza is a Maldivian poet and the author of Heal in Paradise. She writes about mental wellness, island life, and the Maldivian experience.',
          },
        },
      ],
    };
    ...
    const jsonLdScript = `<script type="application/ld+json">${JSON.stringify(faqSchema)}</script>
<script type="application/ld+json">${JSON.stringify(breadcrumb)}</script>`;

    // Enhanced meta tags for AI search
    const enhancedMeta = `
    <meta name="keywords" content="Heal in Paradise FAQ, book questions, ordering information, Maldivian poetry questions, Hawla Riza FAQ" />
    ...
    console.error('Error in FAQ page handler:', error);
