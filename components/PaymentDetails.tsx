...
const bankName = import.meta.env.VITE_BANK_NAME || 'Bank of Maldives';
const accountHolderName = import.meta.env.VITE_ACCOUNT_HOLDER_NAME || 'Mariyam Hawla';
const usdAccountNumber = import.meta.env.VITE_USD_ACCOUNT_NUMBER || '7730000782664';
const mvrAccountNumber = import.meta.env.VITE_MVR_ACCOUNT_NUMBER || '7704240648101';
const priceDetails = import.meta.env.VITE_PRICE_DETAILS || '$25 / MVR 369';
