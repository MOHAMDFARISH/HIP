...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    // Homepage specific metadata (keeping the original homepage content)
    const pageUrl = 'https://hawlariza.com';
    const pageTitle = 'Heal in Paradise: The First Maldivian Literary Souvenir';
    const pageDescription = 'Order the first-ever Maldivian literary souvenir. A powerful collection of Maldivian poetry by Hawla Riza about hope, healing, and island life.';
    const pageImage = 'https://res.cloudinary.com/dmtolfhsv/image/upload/f_auto,q_auto,w_1200/v1760290035/Untitled_design_1_1_gvmxye.png';
